<h2><a href="https://leetcode.com/problems/string-compression-iii/?envType=daily-question&envId=2025-04-02">3163. String Compression III</a></h2><h3>Medium</h3><hr><p>Given a string <code>word</code>, compress it using the following algorithm:</p>
